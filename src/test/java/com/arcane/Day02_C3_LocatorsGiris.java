...
//        WebElement homeElement1 =  chrome.findElement(By.partialLinkText("ome"));
        ...
        - linkText() MUTLAKA text veya metnin tamami bosluk ve noktalama isaretleri dahil yazmak lazim
        - partialLinkText() metnin/text'in tamamini yazabildiginiz gibi bir kismini yazabilirsiniz
        ...
        //isDisplayed() bir elementin sayfada bulunup bulunmadigini dogrular
        //Return type'i boolean => element bulunursa true, bulunmaz ise false olur
        ...
        //Sayfada bulunan toplam link sayisini bul
        // linkler "a" tag ile olusturulur dolayisiyla butun "a" tag ile olustururlan elementleri bulursam
        // tum linkleri bulmus olurum
        ...
        // logged out yapildigini verify et

        Boolean loggedOut = chrome.getCurrentUrl().equals("https://testyou.in/Login.aspx?ReturnUrl=%2fStudent%2fStudentIndex.aspx%3faction%3dlogout&action=logout");
